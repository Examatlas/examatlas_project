...
//     if (!bookId) return; // Prevent toggling if no valid bookId is provided
...
//           const isInWishlist = prevWishlist.includes(bookId); // Check if bookId is already in the wishlist
...
//             <div
//               key={dataItem._id || dataIndex} // Use dataItem._id instead of dataItem.id
//               className="max-w-sm rounded overflow-hidden shadow-lg bg-white p-4 border relative"
//             >
//               {/* Wishlist Icon */}
//               <button
//                 onClick={() => toggleWishlist(dataItem._id)} // Pass the correct book ID
//                 className={`absolute top-2 right-2 w-7 h-7 mt-4 m-3 flex items-center justify-center rounded-full border-2 ${
//                   wishlist.includes(dataItem._id) // Check if the book ID is in the wishlist
...
//                   <strong>Author:</strong> {dataItem.author}
//                 </p>
//                 <p className="text-gray-700 text-base">
//                   <strong>Category:</strong> {dataItem.category}
//                 </p>
//                 <p className="text-gray-700 text-base">
//                   <strong>Keyword:</strong> {dataItem.keyword}
//                 </p>
//                 <p className="text-gray-700 text-base">
...
//       setWishlist(storedWishlist);
//       setCart(storedCart); // Set initial cart state
//     } catch (error) {
//       console.log(error);
//     }
//   };
...
//         ? prevCart.filter((id) => id !== bookId) // Remove from cart
//         : [...prevCart, bookId]; // Add to cart
...
//               >
//                 <FaHeart
//                   className={`text-md ${wishlist.includes(dataItem._id) ? "text-white" : "text-gray-500"}`}
//                 />
//               </button>
...
//               <div className="px-6 py-4 flex justify-center">
//                 <button
//                   onClick={() => addToCart(dataItem._id)} // Call addToCart on button click
//                   className="bg-blue-500 text-white py-2 rounded-lg hover:bg-blue-700 font-semibold w-[270px]"
//                 >
//                   {cart.includes(dataItem._id) ? "Remove from Cart" : "Add to Cart"}
//                 </button>
//               </div>
//             </div>
//           ))
