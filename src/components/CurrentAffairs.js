        ...
        <>
            <div className="flex mt-12">
                ...
                <div className=" w-[850px] pl-44">
                    <h1 className="text-3xl text-blue-700 font-extrabold">Latest Current Affairs</h1>
                ...
                <div className="flex flex-col pl-16">
                    <h1 className="text-3xl text-blue-700 font-extrabold ">Trending Current Affairs</h1>
